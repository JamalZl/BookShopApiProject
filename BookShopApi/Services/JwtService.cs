...
namespace BookShopApi.Services
{
    ...
    {
        string Generate(AppUser user, IList<string> roles, IConfiguration configuration);
    }
    public class JwtService : IJwtService
    {
        public string Generate(AppUser user, IList<string> roles, IConfiguration configuration)
        {
            //jwt create
